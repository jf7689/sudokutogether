      ...
      <div className="flex justify-evenly border-b-1 border-gray-500">
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-300 text-sm md:text-base">Notes</p>
          </div>
        </div>
        <div
          className="hover:bg-slate-950 active:bg-slate-950 w-full h-full md:py-1 cursor-pointer"
        ...
        >
          <div className="flex flex-col items-center gap-0">
            ...
            <p className="text-gray-300 text-sm md:text-base">Erase</p>
          </div>
        </div>
        <div
          className="hover:bg-slate-950 active:bg-slate-950 w-full h-full md:py-1 cursor-pointer"
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-300 text-sm md:text-base">Reset</p>
          </div>
        </div>
      </div>
      <div className="flex justify-evenly">
        {numbers.map((number, i) => {
          return (
            ...
            >
              <div className="text-sky-500 text-3xl text-center md:py-1 cursor-pointer">{number}</div>
            </div>
          );
        })}
      </div>
